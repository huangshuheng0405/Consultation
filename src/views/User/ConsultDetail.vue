...
import { useCancelOrder } from '@/composables/index.js'
...
<template>
  <div class="consult-detail-page" v-if="item">
    ...
    <div class="detail-head">
      ...
      <div class="card">
        ...
        <p class="doc">
          <span>极速问诊</span>
          <span>{{ item.docInfo?.name || '暂未就诊' }}</span>
        </p>
        <van-icon name="arrow" />
      </div>
    </div>
    <div class="detail-patient">
      <van-cell-group :border="false">
        <van-cell
          title="患者信息"
          :value="`${item.patientInfo.name} | ${item.patientInfo.genderValue} | ${item.patientInfo.age}`"
        />
        <van-cell title="患病时长" :value="getIllnessTime(item.illnessTime)" />
        <van-cell title="就诊情况" :value="getConsultFlag(item.consultFlag)" />
    ...
    <div class="detail-order">
      ...
      <van-cell-group :border="false">
        ...
        <van-cell title="应付款" :value="item.actualPayment" />
    ...
    >
      <consult-more :disabled="!item.prescriptionId"></consult-more>
  ...
  <div class="consult-deatil-page" v-else>
