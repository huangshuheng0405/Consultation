...
import { Knowledge } from '@/types/consult.js'
import { useFollow } from '@/composables/index.js'

defineProps<{
  item: Knowledge
}>()

const { loading, follow: followArticle } = useFollow('knowledge')
</script>
